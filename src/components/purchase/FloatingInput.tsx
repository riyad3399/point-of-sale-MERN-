  ...
  return (
    ...
    >
      <input
        ...
        {...rest}
        placeholder=" "
        className="peer w-full rounded-md border border-gray-300 px-3 py-2.5 text-xs text-gray-900 placeholder-transparent shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all duration-200"
      />
      <label
        htmlFor={id}
