            ...
            >
              ...
              >
                <input
                  ...
                  type="text"
                  {...register("tenantId")}
                  className={`peer w-full rounded-xl border pl-4 pr-4 py-3 text-sm text-gray-900 placeholder-transparent bg-white/70 shadow-sm focus:outline-none focus:ring-2 transition-all duration-300
            ${
              errors.tenantId
                ? "border-red-500 focus:border-red-500 focus:ring-red-200"
                : "border-gray-200 focus:border-blue-500 focus:ring-blue-200"
                ...
                <label
                  htmlFor="tenantId"
                  className="absolute left-4 -top-2 text-xs text-gray-500 bg-white/90 px-1 transition-all duration-300 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-gray-400 peer-focus:-top-2 peer-focus:text-xs peer-focus:text-blue-600"
                >
                  Tenant ID (optional)
                </label>
              </motion.div>
