      ...
      >
        ...
        >
          ...
          >
            ...
            <span
              className="absolute right-3 top-[15px] text-gray-400 cursor-pointer select-none"
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            type="submit"
            className="w-full bg-sky-600 text-white py-3 rounded-xl font-semibold shadow-md hover:bg-sky-700 transition-colors duration-200"
          >
            Login
          </motion.button>
        </form>
